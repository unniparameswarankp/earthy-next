    ...
    <g id="insta" transform="translate(-1438 -683.68)">
      ...
      />
        ...
        <div className='d-md-flex flex-wrap text-center justify-content-md-between bottom-sec'>
            ...
            <p className='d-flex gap-10px justify-content-center'><a href="/privacy-policy
">Privacy policy</a><span>|</span><a href="/terms-and-conditions">Terms and Conditions</a></p>
        </div>
      </div>
    </footer>
  );

  ...
  return (
    <div className="bk-about-page">
                ...
                <div className='bk-product-listing-banner'>
                    ...
                    <h1>About Us</h1>
                    <p>  Every business has unique sustainability goals. That's why we offer tailored cleaning solutions that align with your environmental commitments while maintaining operational efficiency. </p>
                    </div>
